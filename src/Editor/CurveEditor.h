...
//     to set its slope.
//   - Double-click empty space to add a key on the curve; right-click a key to delete it.
//   - Right-click empty space for presets (flat, line, ease, kick, sine, auto tangents).
